...
def main():
    ...
    q.container.d1 = 42.0
    assert len(str(q.container.d1).split(
        ".")[1]) == 2, "precision for d1 was incorrect %s" % q.container.d1
    ...
    for i in [(-452.6729, False), (-444.44, True), (-443.22, False), (-330, True), (-222.21, False), (111.2, False), (111.1, True), (446.56, True), (555.55559282, False)]:
        ...
        try:
            ...
            pass
        assert passed == i[
            1], "decimal64 leaf with range was not correctly set (%f -> %s != %s)" % (i[0], passed, i[1])
