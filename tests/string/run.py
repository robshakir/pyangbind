...
def main():
    ...
    for tc in [("a", False), ("b", False), ("abc", False), ("ab", True)]:
        try:
            test_instance.string_container.restricted_length_and_pattern_string = tc[
                0]
            passed = True
        except ValueError:
            passed = False
    ...
    for tc in [("short", False), ("loooooooong", True)]:
        try:
            test_instance.string_container.restricted_length_string_with_range = tc[
                0]
            passed = True
        except ValueError:
            passed = False
    ...
    for tc in [("short", False), ("loooooooong", True), ("toooooooooolooooooooong", False)]:
        try:
            test_instance.string_container.restricted_length_string_range_two = tc[
                0]
            passed = True
        except ValueError:
            passed = False
