...
class BinaryTests(PyangBindTestCase):
    ...
    def test_binary_leafs_exist(self):
        for leaf in ["b1", "b2", "b3"]:
            with self.subTest(leaf=leaf):
                self.assertTrue(
                    hasattr(self.binary_obj.container, leaf),
        ...
        for value in [
            ...
            with self.subTest(value=value):
                ...
                try:
                    ...
                    allowed = False
                self.assertEqual(
                    allowed, value[1], "Could incorrectly set b1 to %s" % value[0]
                )
    ...
    def test_binary_leaf_default_value(self):
        ...
        self.assertEqual(
            ...
            % (self.binary_obj.container.b2._default, default),
        )
    ...
    def test_binary_leaf_is_empty_bitarray_by_default(self):
        ...
        self.assertEqual(
            ...
            % (self.binary_obj.container.b2, empty),
        )
    ...
    def test_set_bitarray_stores_value(self):
        ...
        self.assertEqual(
            self.binary_obj.container.b2,
            bits,
            "Bitarray not successfully set (%s != %s)"
            % (self.binary_obj.container.b2, bits),
        )
    ...
    def test_setting_bitarray_set_changed(self):
        ...
        self.assertTrue(
            self.binary_obj.container.b2._changed(),
            "Bitarray value not flagged as changed (%s != True)"
            % self.binary_obj.container.b2._changed(),
        )
