...
class ListTests(PyangBindTestCase):
  ...
  def test_list_get(self):
    ...
    self.assertEqual(
      ...
      {
        'list-container': {
          'list-eight': {}, 'list-seven': {}, 'list-six': {}, 'list-five': {},
          'list-four': {}, 'list-three': {}, 'list-two': {},
          'list-element': {
  ...
  def test_retrieve_compound_key_with_spaces_using_item(self):
    self.instance.list_container.list_eight.add(val="value one", additional="value two")
    self.assertEqual(
      self.instance.list_container.list_eight._item(val="value one", additional="value two").val,
      "value one"
    )
