...
curl https://raw.githubusercontent.com/YangModels/yang/master/standard/ietf/RFC/ietf-yang-types.yang -o $SDIR/yang/ietf-yang-types.yang
curl https://raw.githubusercontent.com/YangModels/yang/master/standard/ietf/RFC/ietf-inet-types.yang -o $SDIR/yang/ietf-inet-types.yang
