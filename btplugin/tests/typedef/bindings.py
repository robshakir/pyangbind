...
class yc_container__container(object):
  """
     ...
     from YANG module typedef - based on the path /container.
     Each member element of the container is represented as a class
     variable - with a specific YANG type.
    """
  __slots__ = ('__string','__integer','__stringdefault','__integerdefault','__new_string',)

  __string = defineYANGDynClass(base=string, )
  __integer = defineYANGDynClass(base=restricted-int, )
  __stringdefault = defineYANGDynClass(base=string, default="aDefaultValue", )
  __integerdefault = defineYANGDynClass(base=restricted-int, default="10", )
  __new_string = defineYANGDynClass(base=string, )

  def _get_string(self):
    """
      Getter method for string, mapped from YANG variable /container/string (derived-string-type)
    """
    return self.__string
      
  def _set_string(self,v):
    """
      Setter method for string, mapped from YANG variable /container/string (derived-string-type)
      If this variable is read-only (config: false) in the
      source YANG file, then _set_string is considered as a private
      method. Backends looking to populate this variable should
      do so via calling thisObj._set_string() directly.
    """
    try:
      t = defineYANGDynClass(v,base=string)
    except (TypeError, ValueError):
      raise TypeError("""string must be of a type compatible with string""")
    self.__string = t
    self.set()

  def _get_integer(self):
    """
      Getter method for integer, mapped from YANG variable /container/integer (restricted-integer-type)
    """
    return self.__integer
      
  def _set_integer(self,v):
    """
      Setter method for integer, mapped from YANG variable /container/integer (restricted-integer-type)
      If this variable is read-only (config: false) in the
      source YANG file, then _set_integer is considered as a private
      method. Backends looking to populate this variable should
      do so via calling thisObj._set_integer() directly.
    """
    try:
      t = defineYANGDynClass(v,base=restricted-int)
    except (TypeError, ValueError):
      raise TypeError("""integer must be of a type compatible with restricted-int""")
    self.__integer = t
    self.set()

  def _get_stringdefault(self):
    """
      Getter method for stringdefault, mapped from YANG variable /container/stringdefault (derived-string-type)
    """
    return self.__stringdefault
      
  def _set_stringdefault(self,v):
    """
      Setter method for stringdefault, mapped from YANG variable /container/stringdefault (derived-string-type)
      If this variable is read-only (config: false) in the
      source YANG file, then _set_stringdefault is considered as a private
      method. Backends looking to populate this variable should
      do so via calling thisObj._set_stringdefault() directly.
    """
    try:
      t = defineYANGDynClass(v,base=string)
    except (TypeError, ValueError):
      raise TypeError("""stringdefault must be of a type compatible with string""")
    self.__stringdefault = t
    self.set()

  def _get_integerdefault(self):
    """
      Getter method for integerdefault, mapped from YANG variable /container/integerdefault (restricted-integer-type)
    """
    return self.__integerdefault
      
  def _set_integerdefault(self,v):
    """
      Setter method for integerdefault, mapped from YANG variable /container/integerdefault (restricted-integer-type)
      If this variable is read-only (config: false) in the
      source YANG file, then _set_integerdefault is considered as a private
      method. Backends looking to populate this variable should
      do so via calling thisObj._set_integerdefault() directly.
    """
    try:
      t = defineYANGDynClass(v,base=restricted-int)
    except (TypeError, ValueError):
      raise TypeError("""integerdefault must be of a type compatible with restricted-int""")
    self.__integerdefault = t
    self.set()

  def _get_new_string(self):
    """
      Getter method for new_string, mapped from YANG variable /container/new_string (new-string-type)
    """
    return self.__new_string
      
  def _set_new_string(self,v):
    """
      Setter method for new_string, mapped from YANG variable /container/new_string (new-string-type)
      If this variable is read-only (config: false) in the
      source YANG file, then _set_new_string is considered as a private
      method. Backends looking to populate this variable should
      do so via calling thisObj._set_new_string() directly.
    """
    try:
      t = defineYANGDynClass(v,base=string)
    except (TypeError, ValueError):
      raise TypeError("""new_string must be of a type compatible with string""")
    self.__new_string = t
    self.set()

  string = property(_get_string, _set_string)
  integer = property(_get_integer, _set_integer)
  stringdefault = property(_get_stringdefault, _set_stringdefault)
  integerdefault = property(_get_integerdefault, _set_integerdefault)
  new_string = property(_get_new_string, _set_new_string)


  __elements = {'string': string, 'integer': integer, 'stringdefault': stringdefault, 'integerdefault': integerdefault, 'new_string': new_string, }
...
class typedef(object):
  """
     This class was auto-generated by the PythonClass plugin for PYANG
     from YANG module typedef - based on the path /.
     Each member element of the container is represented as a class
     variable - with a specific YANG type.
    """
