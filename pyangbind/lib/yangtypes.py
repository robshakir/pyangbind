...
# reserved names in Python, such as being builtin types and keywords.
# This encompasses both py2 and py3, and generated using the following:
#
#     import six
#     import string
#     import keyword
...
#
#     kw = [x.lower() for x in keyword.kwlist]
#     bi = [x for x in dir(builtins) if not x.startswith('_') and not x[0] in string.ascii_uppercase]
#     set(kw + bi)
#
# And then add the resulting set for each python version plus the pyangbind names.
reserved_name = {
    "abs",
    "all",
    "and",
    ...
    "yield",
    "zip",
    # additional names for pyangbind API etc
    "add",
    "decimal",
    "default",
    "delete",
